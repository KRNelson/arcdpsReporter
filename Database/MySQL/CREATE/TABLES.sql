...
-- Buff
CREATE TABLE IF NOT EXISTS rpt.IRPTBUF_BUF (
     LOG_SYS_NR CHAR(36)
    ,LOG_BUF_ID CHAR(10)

    ,PRIMARY KEY(LOG_SYS_NR, LOG_BUF_ID)
    ,FOREIGN KEY(LOG_SYS_NR) REFERENCES log.TLOGCAT(LOG_SYS_NR) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS rpt.IRPTBUF_MAP (
    ...
    ,LOG_BUF_NA VARCHAR(256) CHARACTER SET utf8mb4 -- string Name
    ,LOG_ICN_TE VARCHAR(256) -- string Icon
    ,LOG_STK_IR BOOL -- bool Stacking
    ,LOG_CHL_IR BOOL -- bool ConversionBasedHealing
    ,LOG_HHL_IR BOOL -- bool HybridHealing
    ...
    ,PRIMARY KEY(LOG_SYS_NR, LOG_BUF_ID)
    ,FOREIGN KEY(LOG_SYS_NR) REFERENCES log.TLOGCAT(LOG_SYS_NR) ON DELETE CASCADE
    ,FOREIGN KEY(LOG_SYS_NR, LOG_BUF_ID) REFERENCES rpt.IRPTBUF_BUF(LOG_SYS_NR, LOG_BUF_ID) ON DELETE CASCADE
);
...
*/
CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_SLFBUFF (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index
    ,LOG_BUF_GEN FLOAT -- double generation
    ,LOG_OVR_GEN FLOAT -- double overstack
    ,LOG_WST_GEN FLOAT -- double wasted
    ,LOG_UEX_GEN FLOAT -- double unknownextended
    ,LOG_BEX_GEN FLOAT -- double byextension
    ,LOG_EXT_GEN FLOAT -- double extended

    ,PRIMARY KEY(LOG_SYS_NR, LOG_ACC_NA, LOG_BUF_ID, LOG_PHS_NR)
    ,FOREIGN KEY(LOG_SYS_NR) REFERENCES log.TLOGCAT(LOG_SYS_NR) ON DELETE CASCADE
    ,FOREIGN KEY(LOG_SYS_NR, LOG_ACC_NA) REFERENCES rpt.IRPTPLY_PLAYERS(LOG_SYS_NR, LOG_ACC_NA) ON DELETE CASCADE
    ,FOREIGN KEY(LOG_SYS_NR, LOG_BUF_ID) REFERENCES rpt.IRPTBUF_MAP(LOG_SYS_NR, LOG_BUF_ID) ON DELETE CASCADE
    ,FOREIGN KEY(LOG_SYS_NR, LOG_PHS_NR) REFERENCES rpt.IRPTPHS_PHASE(LOG_SYS_NR, LOG_IDX_NR) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_GRPBUFF (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index
...
CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_OFFBUFF (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index
...
CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_SQDBUFF (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index
...
CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_SLFBUFFACT (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index
...
CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_GRPBUFFACT (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index
...
CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_OFFBUFFACT (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index
...
CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_SQDBUFFACT (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index
...
CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_BUFUPTM (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index

    ,LOG_BUF_UP FLOAT -- double uptime
    ,LOG_BUF_PR FLOAT -- double presence
...
CREATE TABLE IF NOT EXISTS rpt.IRPTPLY_BUFUPTMACT (
	 LOG_SYS_NR CHAR(36)
	,LOG_ACC_NA VARCHAR(256) CHARACTER SET utf8mb4 
    ,LOG_BUF_ID CHAR(10) -- long Id
    ,LOG_PHS_NR INT -- int index
...
CREATE TABLE IF NOT EXISTS sum.TSUMSQD_SUMMARY (
    LOG_SUM_ID CHAR(40) -- SHA1(CONCAT(LOG_GRP_NR, LOG_CNT_NR))
    ,LOG_GRP_NR INT
    ,LOG_CNT_NR INT

    ,PRIMARY KEY(LOG_SUM_ID)
);
...
-- Mechanics
*/
CREATE TABLE IF NOT EXISTS sum.TSUMTYP_SUMMARY (
...
CREATE TABLE IF NOT EXISTS sum.TSUMRPT_AVG (
    ...
    ,PRIMARY KEY(LOG_SYS_NR, LOG_SUM_ID, LOG_TYP_ID)
    ,FOREIGN KEY(LOG_SYS_NR) REFERENCES log.TLOGCAT(LOG_SYS_NR) ON DELETE CASCADE
    ,FOREIGN KEY(LOG_SUM_ID) REFERENCES sum.TSUMSQD_SUMMARY(LOG_SUM_ID) ON DELETE CASCADE
    ,FOREIGN KEY(LOG_TYP_ID) REFERENCES sum.TSUMTYP_SUMMARY(LOG_TYP_ID) ON DELETE CASCADE

);

CREATE TABLE IF NOT EXISTS sum.TSUMRPT_CNT (
    LOG_SYS_NR CHAR(36) -- Log ID
    ,LOG_SUM_ID CHAR(40) -- ID that maps to the subgroup
    ,LOG_TYP_ID CHAR(40) -- ID that maps to the stat/type
